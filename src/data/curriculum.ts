...
export const tracks: Track[] = [
  ...
  },
  {
    ...
    published: ['Partial Derivatives & the Gradient', 'The Jacobian & Multivariate Chain Rule', 'The Hessian & Second-Order Analysis', 'Inverse & Implicit Function Theorems'],
    planned: [],
  },
  {
  ...
  },
  {
    ...
    published: ['Series Convergence & Tests', 'Power Series & Taylor Series', 'Fourier Series & Orthogonal Expansions', 'Approximation Theory'],
    planned: [],
  },
  {
    id: 'odes',
    ...
    domain: 'odes',
    published: ['First-Order ODEs & Existence Theorems', 'Linear Systems & Matrix Exponential', 'Stability & Dynamical Systems', 'Numerical Methods for ODEs'],
    planned: [],
  },
  {
  ...
  },
  {
    ...
    published: ['Metric Spaces & Topology', 'Normed & Banach Spaces', 'Inner Product & Hilbert Spaces'],
    planned: [
