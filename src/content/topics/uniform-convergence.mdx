...
- **Approximation Theory & Convergence Rates** *(coming soon)* — Stone-Weierstrass theorem (polynomials are dense in $C([a,b])$ under the sup-norm); rates of uniform approximation.
