...
- [**Normed & Banach Spaces**](/topics/banach-spaces) — $C([a,b])$ is a Banach space (complete normed vector space); completeness is the Cauchy criterion for uniform convergence.
