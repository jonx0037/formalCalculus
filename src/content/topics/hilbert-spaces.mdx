...
| Topic | Connection |
|-------|-----------|
| [Metric Spaces](/topics/metric-spaces) | Completeness and compactness foundations. Inner product spaces add geometry to the metric layer. |
| [Banach Spaces](/topics/banach-spaces) | Every Hilbert space is Banach. The inner product replaces Baire-powered arguments with projection-based ones. |
| [$L^p$ Spaces](/topics/lp-spaces) | $L^2$ is the canonical Hilbert space. Duality $(L^p)^* \cong L^q$ becomes the simpler $H^* \cong H$ via Riesz. |
| [Fourier Series](/topics/fourier-series) | Trigonometric functions as an ONB for $L^2[-\pi, \pi]$. Parseval's identity as energy conservation. |
| [Approximation Theory](/topics/approximation-theory) | Best $L^2$ approximation = orthogonal projection. Legendre polynomials as an ONB. |
| [Radon-Nikodym](/topics/radon-nikodym) | Conditional expectation as $L^2$ projection onto a sub-$\sigma$-algebra. |
| <a href="https://formalml.com/topics/kernel-methods" target="_blank" rel="noopener noreferrer">Kernel Methods</a> (formalML) | RKHS is a Hilbert space. Representer theorem via Riesz. |
| <a href="https://formalml.com/topics/gradient-descent" target="_blank" rel="noopener noreferrer">Gradient Descent</a> (formalML) | Riesz identification: gradients as descent directions in the primal space. |
| <a href="https://formalml.com/topics/spectral-methods" target="_blank" rel="noopener noreferrer">Spectral Methods</a> (formalML) | PCA and spectral clustering via the spectral theorem. |
