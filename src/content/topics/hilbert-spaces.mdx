...
Moreover, $\|\varphi\|_{H^*} = \|y\|_H$. The map $\varphi \mapsto y$ is a conjugate-linear isometric isomorphism $H^* \to H$.
</TheoremBlock>
...
Where this topic added one axiom (the inner product) to Banach spaces and gained geometric power, Topic 32 will add one more idea — *variation* — to function spaces and gain the ability to find optimal functions. The staircase of abstraction reaches its summit.
