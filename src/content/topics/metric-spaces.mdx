...
formalstatisticsConnections:
  - topic: "empirical-processes"
    ...
    relationship: "Donsker's theorem is a statement in the metric space D[0,1] with the Skorohod metric: √n(F_n - F) converges in distribution to the Brownian bridge. Continuity of functionals in this metric is what the continuous mapping theorem exploits."
  - topic: "bayesian-computation-and-mcmc"
    site: "formalstatistics"
    relationship: "Convergence rates of MCMC are metric-space statements: the chain converges to its stationary distribution in total-variation distance or Wasserstein distance. Contraction-mapping arguments (coupling) give geometric convergence rates."
connections:
...
downstreamConnections:
  - topic: "banach-spaces"
    relationship: "Adds algebraic structure (vector space + norm) on top of the metric-space framework. The Baire Category Theorem, Open Mapping Theorem, Closed Graph Theorem, and Uniform Boundedness Principle — all deferred from this topic — are proved there."
  - topic: "hilbert-spaces"
    relationship: "Adds the inner-product structure that gives angles, orthogonality, the projection theorem, Riesz representation, and the RKHS construction behind kernel methods."
  - topic: "calculus-of-variations"
    relationship: "The Euler-Lagrange equation, second variation, and the direct method for existence of minimizers via weak compactness. Arzelà-Ascoli from this topic reappears in Sobolev spaces as the compactness tool variational problems rely on."
references:
  - type: "book"
    title: "Topology"
    authors: "Munkres, J. R."
