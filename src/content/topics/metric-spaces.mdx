...
formalmlConnections:
  - topic: "gradient-descent"
    site: "formalml"
    relationship: "The contraction-mapping theorem guarantees convergence of fixed-point iterations, and Lipschitz continuity of gradient maps — formalized in this topic — controls convergence rates of gradient descent. The gradient-descent map $T(\\theta) = \\theta - \\eta\\nabla L(\\theta)$ becomes a contraction with constant $\\le 1 - \\eta\\mu$ on $\\mu$-strongly-convex objectives."
