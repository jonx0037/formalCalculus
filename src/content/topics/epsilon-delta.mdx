...
- [**The Riemann Integral & FTC**](/topics/riemann-integral) — continuous functions on $[a, b]$ are Riemann integrable. Continuity is the "easy" sufficient condition.
- [**Mean Value Theorem & Taylor Expansion**](/topics/mean-value-taylor) — MVT requires continuity on $[a, b]$ and differentiability on $(a, b)$.
