...
- [First-Order ODEs & Existence Theorems](/topics/first-order-odes) — scalar linear equations are the 1×1 case; Picard-Lindelöf extends to systems
- [The Jacobian & Multivariate Chain Rule](/topics/jacobian) — the system matrix $A$ is the constant Jacobian; eigendecomposition is a change of basis

**Cross-track connections:**

- [Power & Taylor Series](/topics/power-taylor-series) — the matrix exponential $e^{At} = \sum (At)^k/k!$ is a power series with infinite radius of convergence
- [The Hessian & Second-Derivative Test](/topics/hessian) — eigenvalue classification of equilibria mirrors the second-derivative test for critical points
- [The Derivative & Chain Rule](/topics/derivative) — $\frac{d}{dt}e^{At} = Ae^{At}$ is the matrix analog of $\frac{d}{dt}e^{at} = ae^{at}$
- [Completeness & Compactness](/topics/completeness-compactness) — convergence of the matrix exponential series requires completeness of the matrix algebra

**Looking ahead in this track:**

- [Stability & Dynamical Systems](/topics/stability-dynamics) — phase portrait classification becomes the linearization stability theorem; Lyapunov functions and bifurcation theory
- [Numerical Methods for ODEs](/topics/numerical-odes) — numerical computation of the matrix exponential (scaling-and-squaring, Padé), stiff systems, and adaptive methods

**Forward links to formalML:**

- [Gradient Descent](https://formalml.com/topics/gradient-descent) — training dynamics on quadratic loss as the linear system $\dot{\theta} = -H\theta$
- [Spectral Theorem](https://formalml.com/topics/spectral-theorem) — spectral decomposition is the computational engine of the matrix exponential
- [Information Geometry](https://formalml.com/topics/information-geometry) — natural gradient descent as a linear system in the statistical manifold's tangent space
