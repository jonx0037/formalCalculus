...
- [**Approximation Theory**](/topics/approximation-theory) — Weierstrass approximation theorem and non-Taylor polynomial approximations
- [**Linear Systems & Matrix Exponential**](/topics/linear-systems) — matrix exponential $e^{At} = \sum (At)^k/k!$ as a power series solution to $\dot{x} = Ax$
