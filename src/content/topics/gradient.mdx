...
The pattern is the same — the derivative provides the coefficients of the linear approximation. In the next topic (**The Jacobian & Multivariate Chain Rule** *(coming soon)*), the derivative of a *vector-valued* function becomes a matrix, and the tangent hyperplane becomes an affine subspace.
</TheoremBlock>
