...
references:
  ...
  - type: "book"
    ...
    year: 2012
    url: "https://www.wiley.com/en-us/Elementary+Differential+Equations+and+Boundary+Value+Problems-p-9781119777687"
...
- [Numerical Methods for ODEs](/topics/numerical-odes) — Euler's method is the simplest discretization; RK4 and adaptive methods are the workhorses
- [**Metric Spaces & Topology**](/topics/metric-spaces) — the Banach Contraction Mapping Theorem is proved in full, giving the abstract result that powers the Picard-Lindelöf argument from this topic and the Inverse Function Theorem from Topic 12
