...
![Three-panel: standard normal density on R, Exponential density on [0, ∞), and Beta density on [0, 1], each with a shaded region whose area is the corresponding probability — the picture every "probability is the area under the curve" intuition is grounded in](/images/topics/radon-nikodym/probability-densities.png)
