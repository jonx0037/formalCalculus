...
{/* Viz components are imported in Commits 4 and 5:
    - DominatedConvergenceExplorer (Section 7, flagship)
...
{/* TODO(Commit 4): <DominatedConvergenceExplorer client:visible /> */}
