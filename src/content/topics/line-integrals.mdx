...
downstreamConnections:
  - topic: "surface-integrals"
    relationship: "Stokes' theorem generalizes Green's theorem from 2D to 3D: ∮_C F · dr = ∬_S (∇ × F) · dS. The divergence theorem relates surface integrals to volume integrals."
  - topic: "first-order-odes"
    relationship: "Exact differential equations M dx + N dy = 0 are exact when M_y = N_x — the same criterion as conservative fields. The integrating factor technique corresponds to finding a potential function."
  - topic: "metric-spaces"
    relationship: "The topological vocabulary — open sets, continuity via preimages, homeomorphism, fundamental groups — underlies simply connected vs. non-simply-connected domains and the topological obstruction to conservativeness."
  - topic: "calculus-of-variations"
    relationship: "Functionals J[γ] = ∫_a^b L(γ, γ', t) dt are line integrals over path space. Extremal paths satisfy the Euler-Lagrange equation — the direct descendant of this topic's variational structure."
references:
  - type: "book"
