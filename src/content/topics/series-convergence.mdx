...
- **Fourier Series & Orthogonal Expansions** *(coming soon)* — convergence of Fourier coefficients requires summability methods that generalize the convergence tests here.
