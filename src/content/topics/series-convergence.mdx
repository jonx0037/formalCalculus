...
- [**Approximation Theory**](/topics/approximation-theory) — Stone-Weierstrass and uniform convergence of approximating series.
- [**Sigma-Algebras & Measures**](/topics/sigma-algebras) — countable additivity of measures is defined via convergent series; the Borel-Cantelli lemma is a series convergence test for probability.
