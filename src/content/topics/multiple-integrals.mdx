...
formalmlConnections:
  ...
  - topic: "sparse-bayesian-priors"
    site: "formalml"
    relationship: "Sparse Bayesian priors' §2 scale-mixture-of-Normals representation marginalizes local scales $\\lambda_j$ out of the joint prior — a multivariate Lebesgue integral over the $(\\lambda_1, \\ldots, \\lambda_p, \\tau)$ hyperparameter space. The Polson–Scott sparsity characterization (Theorem 1) of $p(\\beta_j)$ presupposes the iterated-integral identity developed here."
  - topic: "statistical-depth"
    site: "formalml"
    relationship: "Statistical depth's halfspace mass $F(H)$ and functional-band mass $F(B)$ are concrete multivariate integrals over closed halfspaces and bands; the §§2–5 derivations and Proposition 1's convexity proof use Fubini-style iterated integration over those regions."
