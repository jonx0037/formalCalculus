...
- [The Riemann Integral & FTC](/topics/riemann-integral) — the 1D integration machinery that gets iterated here
- [Partial Derivatives & the Gradient](/topics/gradient) — the "hold one variable constant" viewpoint used in iterated integration
- [Epsilon-Delta & Continuity](/topics/epsilon-delta) — uniform continuity is the engine of Fubini's proof
- [Completeness & Compactness](/topics/completeness-compactness) — Heine-Cantor theorem ensures integrability
- [Improper Integrals & Special Functions](/topics/improper-integrals) — the Gaussian integral motivates change of variables
- [The Jacobian & Multivariate Chain Rule](/topics/jacobian) — the Jacobian determinant appears in the next topic

This topic leads to:
- [**Change of Variables & the Jacobian Determinant**](/topics/change-of-variables) — the substitution rule for multiple integrals, with the Jacobian determinant as the volume scaling factor
- [**Line Integrals & Conservative Fields**](/topics/line-integrals) — Green's theorem connects line integrals to double integrals
- [**Surface Integrals & the Divergence Theorem**](/topics/surface-integrals) — triple integrals and the divergence theorem
- **The Lebesgue Integral** *(coming soon)* — the Fubini-Tonelli theorem generalizes from Riemann to Lebesgue
