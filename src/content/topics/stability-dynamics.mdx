...
- **Numerical Methods for ODEs** *(coming soon)* — numerical stability of ODE solvers mirrors continuous-time stability; stiffness detection uses the eigenvalue spread of the Jacobian
