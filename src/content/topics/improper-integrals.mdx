...
- **Series Convergence & Tests** *(coming soon)* — the integral test for series convergence uses improper integrals: $\sum_{n=1}^\infty f(n)$ converges iff $\int_1^\infty f(x)\,dx$ converges.
