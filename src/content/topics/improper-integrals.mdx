...
- **Multiple Integrals & Fubini's Theorem** *(coming soon)* — the Gaussian integral proof in full multivariable rigor, Fubini's theorem for improper double integrals.
