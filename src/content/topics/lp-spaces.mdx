...
- **Normed & Banach Spaces** *(coming soon)* — $L^p$ is the canonical example of a Banach space (a complete normed vector space). Topic 30 develops the abstract theory; this topic provides the indispensable concrete example that makes the abstract theory feel grounded.
