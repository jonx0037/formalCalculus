...
formalmlConnections:
  ...
  - topic: "semiparametric-inference"
    site: "formalml"
    relationship: "The $L^2(P_X)$-norm convergence rates that govern §7's rate condition — both for the nuisance error $\\|\\hat\\eta - \\eta\\|_{L^2}$ and for the Cauchy–Schwarz bound on the product-of-errors $R_2$ remainder — require the $L^p$ machinery developed in §§3–7 here."
