...
![L1 vs L2 ball geometry with level curves of a least-squares loss — the L1 corner at the axis is where Lasso produces sparsity, the smooth L2 sphere is where Ridge shrinks but never zeros](/images/topics/lp-spaces/lp-ball-regularization.png)
...
![Four-panel ML connections to Lp spaces: regression as L2 projection, ridge/lasso constraint sets, score matching in L2, Wasserstein distances](/images/topics/lp-spaces/ml-connections-27.png)
