...
formalstatisticsConnections:
  - topic: "kernel-density-estimation"
    ...
    relationship: "MISE = E[∫ (f̂_n(x) - f(x))² dx] = E[‖f̂_n - f‖²_{L²}] is the squared L² distance between estimator and target. Optimal bandwidth minimizes this L² risk. Sobolev-space norms control smoothness-adaptive minimax rates."
  - topic: "regularization-and-penalized-estimation"
    site: "formalstatistics"
    relationship: "Ridge regression minimizes ‖y - Xβ‖²_{L²} + λ‖β‖²_{L²} — the L² norms make the problem a closed-form projection. Lasso replaces the ℓ₂ penalty with the ℓ₁ norm, producing sparse solutions. Elastic net blends the two."
  - topic: "bootstrap"
    site: "formalstatistics"
    relationship: "Bootstrap consistency is often stated as L² convergence of the bootstrap distribution to the true sampling distribution. Moment-matching arguments in second-order bootstrap validity proofs work in L²."
  - topic: "hypothesis-testing"
    site: "formalstatistics"
    relationship: "Chi-squared and goodness-of-fit test statistics are L² norms of standardized residuals. Cramér–von Mises and Anderson–Darling statistics measure L² distance between empirical and hypothesized CDFs."
connections:
...
downstreamConnections:
  - topic: "radon-nikodym"
    relationship: "Densities dν/dμ live in L¹(μ). The Radon-Nikodym proof uses L² projection onto closed subspaces of measure differences — an Lᵖ technique applied to a measure-theoretic problem."
  - topic: "banach-spaces"
    relationship: "Lᵖ is the canonical example of a Banach space (a complete normed vector space). The abstract theory — bounded operators, operator norms, the Baire Category Theorem and its three consequences, dual spaces — generalizes this topic's concrete Lᵖ results."
  - topic: "hilbert-spaces"
    relationship: "L² is the canonical Hilbert space. Orthogonal projection, the Riesz representation theorem (the general version of Section 10's special case), and the spectral theorem all generalize properties we saw in L² here."
references:
  - type: "book"
    title: "Real Analysis"
