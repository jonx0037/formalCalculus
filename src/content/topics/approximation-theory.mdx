...
- **Metric Spaces & Topology** *(coming soon)* — Density of polynomials in $C[a,b]$ under the sup-norm is a statement about metric space topology; the contraction mapping theorem connects to Bernstein operator convergence.
