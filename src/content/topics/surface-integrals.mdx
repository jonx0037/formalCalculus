...
- **Calculus of Variations** *(coming soon)* — The Euler-Lagrange equation on domains in $\mathbb{R}^n$ uses the divergence theorem to move derivatives off the test function.
