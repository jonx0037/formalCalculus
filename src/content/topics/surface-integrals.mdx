...
downstreamConnections:
  - topic: "stability-dynamics"
    relationship: "Lyapunov stability analysis uses the divergence theorem to establish energy conservation and dissipation — the flux of energy through a surface bounds the rate of change of energy in the interior."
  - topic: "sigma-algebras"
    relationship: "Surface measures and the co-area formula generalize the surface integral to the measure-theoretic setting — the abstract framework formalizes what this topic does concretely on parameterized surfaces."
  - topic: "hilbert-spaces"
    relationship: "Sobolev spaces — the natural domain for weak derivatives of functions on surfaces — are Hilbert spaces when p = 2. The inner-product machinery there generalizes the integration on surfaces developed here."
  - topic: "calculus-of-variations"
    relationship: "The Euler-Lagrange equation for area-minimizing surfaces, Sobolev spaces as the natural domain for weak solutions, and the connection to minimal surfaces — where the variational and integral perspectives meet."
references:
  - type: "book"
