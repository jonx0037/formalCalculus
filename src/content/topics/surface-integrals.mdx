...
- **Stability & Dynamical Systems** *(coming soon)* — Lyapunov stability analysis uses the divergence theorem to establish energy conservation and dissipation: the flux of energy through a surface bounds the rate of change of energy in the interior.
