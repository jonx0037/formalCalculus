...
formalstatisticsConnections:
  - topic: "kernel-density-estimation"
    ...
    relationship: "Optimal bandwidth and adaptive estimator selection can be framed as variational problems — minimizing a smoothness-penalized L² risk functional over a function space. The Euler–Lagrange equations characterize critical points of the risk."
connections:
...
Optimal bandwidth and adaptive estimator selection for kernel density estimation can be framed as variational problems — minimizing a smoothness-penalized $L^2$ risk functional over a function space. The Euler–Lagrange equations characterize critical points of the risk; the direct method (lower semicontinuity + weak compactness in a Sobolev space) guarantees a minimizer exists. See <a href="https://formalstatistics.com/topics/kernel-density-estimation" class="formalstatistics-badge" target="_blank" rel="noopener">formalStatistics</a> **Kernel Density Estimation**.
