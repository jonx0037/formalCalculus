...
- **Inner Product & Hilbert Spaces** *(coming soon)* — Inner products, orthogonal complements, projection theorem, Riesz representation, RKHS foundations.
- **Calculus of Variations** *(coming soon)* — Optimization of functionals on Banach/Hilbert spaces. The Euler-Lagrange equations, the direct method, and connections to physics-informed neural networks and optimal transport.
