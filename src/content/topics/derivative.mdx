...
- **The Jacobian & Multivariate Chain Rule** *(coming soon)* — The Jacobian matrix generalizes the scalar derivative, and the multivariate chain rule $J_{f \circ g} = J_f \cdot J_g$ is what backpropagation actually computes in multi-dimensional networks.
