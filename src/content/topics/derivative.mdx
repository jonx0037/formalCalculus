...
formalstatisticsConnections:
  ...
  - topic: "point-estimation"
    site: "formalstatistics"
    relationship: "The Cramér–Rao lower bound differentiates under the integral sign — a maneuver justified by dominated-convergence conditions. The delta method for estimators of the form g(θ̂) is a first-order Taylor expansion: g(θ̂) ≈ g(θ) + g'(θ)(θ̂ - θ)."
  ...
  - topic: "method-of-moments"
    site: "formalstatistics"
    relationship: "Topic 15's delta method uses the Jacobian of the moment-to-parameter map (a multivariate chain rule); the M-estimator sandwich variance A⁻¹BA⁻¹^T uses partial derivatives of the estimating function ψ(x; θ) with respect to θ."
